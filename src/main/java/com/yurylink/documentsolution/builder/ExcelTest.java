...
//        }
//
//        public static Font getFont8(boolean azul) {
//            if (azul)
//                return FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new Color(0, 0, 255));
//            else
//                return FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new Color(0, 0, 0));
//        }
//
//        public static Font getFont10Normal(boolean azul) {
//            if (azul)
//                return FontFactory.getFont(FontFactory.HELVETICA, 10, Font.NORMAL, new Color(0, 0, 255));
//            else
//                return FontFactory.getFont(FontFactory.HELVETICA, 10, Font.NORMAL, new Color(0, 0, 0));
//        }
//
//        public static Font getFont(int tamanho, boolean bold) {
//            if (bold) {
//                return FontFactory.getFont(FontFactory.HELVETICA, tamanho, Font.BOLD, new Color(0, 0, 0));
//            } else {
